...
};case 4:return function(e,r,u,o){return n.call(t,e,r,u,o)}}return ae(n,t)}function Y(n){function t(){for(var n=-1,v=arguments.length,y=Re(v);++n<v;)y[n]=arguments[n];if(i&&(y=It(i,l,y)),a){for(var n=a,d=f,b=-1,_=d.length,w=-1,j=yr(y.length-_,0),k=-1,A=n.length,I=Re(j+A);++w<j;)I[w]=y[w];for(j=w;++k<A;)I[j+k]=n[k];for(;++b<_;)I[j+d[b]]=y[w++];y=I}return p&&(n=[],v-=n.length,v<u)?(r|=O,r&=~E,g||(r&=~(x|C)),v=yr(u-v,0),Y([e,r,v,o,y,null,n])):(v=c?o:this,s&&(e=v[h]),this instanceof t?(v=m(e.prototype),n=e.apply(v,y),ye(n)?n:v):e.apply(v,y))
...
u[t]=[o,n[o]]}return u},o.partial=function(n){if(n)var t=n[I]?n[I][2]:n.length,e=Ut(arguments,1),t=t-e.length;return Nt(n,O,t,null,e)},o.partialRight=function(n){if(n)var t=n[I]?n[I][2]:n.length,e=Ut(arguments,1),t=t-e.length;return Nt(n,E,t,null,null,e)},o.partition=Nr,o.pick=we,o.pluck=Tr,o.property=Se,o.pull=function(n){for(var t=0,e=arguments.length,r=n?n.length:0;++t<e;)for(var u=-1,o=arguments[t];++u<r;)n[u]===o&&(ar.call(n,u--,1),r--);return n},o.range=function(n,t,e){n=+n||0,e=null==e?1:+e||0,null==t?(t=n,n=0):t=+t||0;
